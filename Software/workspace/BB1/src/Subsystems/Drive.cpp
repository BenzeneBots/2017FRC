...
#define INCHES_PER_TICK 0.01410//NEED TO MEASURE
...
double Drive::GetLeftEncoderValue(){
	double dist = leftDriveEncoder->GetRaw() * INCHES_PER_TICK;
	return dist;
}

double Drive::GetRightEncoderValue(){
	double dist = rightDriveEncoder->GetRaw()* INCHES_PER_TICK;
	return dist;
}
...
double Drive::GetLeftRate(){
	double leftRate = leftDriveEncoder->GetRate();
	return leftRate;
}

double Drive::GetRightRate(){
	double rightRate = rightDriveEncoder->GetRate();
	return rightRate;
}
