...
void Robot::RobotInit() {
	...
	autonomousCommand.reset(new AutonomousLeftGear());
...
void Robot::AutonomousPeriodic() {
	...
	SmartDashboard::PutNumber("imuHeading", yaw);

	double leftEnc = Robot::drive->GetLeftRate();
	SmartDashboard::PutNumber("leftEncoder", leftEnc);

	double rightEnc = Robot::drive->GetRightRate();
	SmartDashboard::PutNumber("rightEncoder", rightEnc);
}
