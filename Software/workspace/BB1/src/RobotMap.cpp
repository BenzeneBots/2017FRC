...
std::shared_ptr<SpeedController> RobotMap::blenderBlenderMotor;
...
void RobotMap::init() {
    ...
    blenderBlenderMotor.reset(new VictorSP(4));
    lw->AddActuator("Blender", "BlenderMotor", std::static_pointer_cast<VictorSP>(blenderBlenderMotor));
