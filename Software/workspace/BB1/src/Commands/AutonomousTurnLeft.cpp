...
void AutonomousTurnLeft::Execute() {
	...
	if(leftEncVal + rightEncVal > .3){ //right encoder moved too much relative to left
		rightTurnSpeed -= 0.003;
	}
	else if(leftEncVal + rightEncVal < -.3){//left encoder moved too much relative to right
		leftTurnSpeed -= 0.003;
	}
