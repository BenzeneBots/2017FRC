...
typedef struct {int distance; int speed; int theta;} params;  // look up table data structure
typedef struct {int speed; int theta;} results;  // return value data structure
