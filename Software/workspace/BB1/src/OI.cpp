...
OI::OI() {
    ...
    manipY->WhenPressed(new SetGearFlap());
    ...
    SmartDashboard::PutData("AutonomousLeftGear", new AutonomousLeftGear());
    SmartDashboard::PutData("AutonomousRightGear", new AutonomousRightGear());
