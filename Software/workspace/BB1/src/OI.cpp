...
OI::OI() {
    ...
    manipRT->WhenPressed(new FloorLoad(0));
    manipLT.reset(new JoystickButton(manipulator.get(), 5));
    manipLT->WhenPressed(new FloorLoad(0));
    ...
    SmartDashboard::PutData("Floor Load: forward", new FloorLoad(1));
    SmartDashboard::PutData("Floor Load: reverse", new FloorLoad(2));
