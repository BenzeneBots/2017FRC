...
public:
	...
	static std::shared_ptr<SpeedController> driveLeft;
	static std::shared_ptr<SpeedController> driveRight;
	static std::shared_ptr<RobotDrive> driveDrivetrain;
	static std::shared_ptr<SpeedController> driveStrafe;
	static std::shared_ptr<SpeedController> intakeIntakeMotor;
	static std::shared_ptr<SpeedController> blenderBlenderMotor;
